...
const samplerFunc = () => {
  const kick = new __WEBPACK_IMPORTED_MODULE_0_Tone___default.a.Player({url: "../audio/Bef_K.wav"}).toMaster();
  const snare = new __WEBPACK_IMPORTED_MODULE_0_Tone___default.a.Player({url: "../audio/Box_Snr2.wav"}).toMaster();
  const hat = new __WEBPACK_IMPORTED_MODULE_0_Tone___default.a.Player({url: "../audio/Aki_H4.wav"}).toMaster();
