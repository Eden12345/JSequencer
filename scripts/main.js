...
const scrubs1 = new Tone.Player({url: "samples/scrubs/noscrubs1.wav"}).toMaster();
const scrubs2 = new Tone.Player({url: "samples/scrubs/noscrubs2.wav"}).toMaster();
const scrubs3 = new Tone.Player({url: "samples/scrubs/noscrubs3.wav"}).toMaster();
const scrubs4 = new Tone.Player({url: "samples/scrubs/noscrubs4.wav"}).toMaster();
const scrubs5 = new Tone.Player({url: "samples/scrubs/noscrubs5.wav"}).toMaster();
